...
DURATION = 3600  # Set the timeout duration in seconds (e.g., 3600 seconds = 1 hour)
N_TRIALS =1
...
def suggest_hyperparameters(trial):
    ...
    return lr, dropout, batch_size, transformer_dim, num_heads, transformer_depth, fc_neurons1, fc_neurons2, fc_transformer
...
def objective(trial, experiment, device, options=None):
    ...
    with mlflow.start_run(experiment_id=experiment.experiment_id) as run:
        ...
        lr, dropout, batch_size, transformer_dim, num_heads, transformer_depth, fc_neurons1, fc_neurons2, fc_transformer = suggest_hyperparameters(trial)
        ...
        criterion = nn.CrossEntropyLoss().to(device)  # Correct placement of criterion
